...
import com.spring.advanced2.model.StartUp;
...
public class ApiController {
    ...
    public static String STARTUP_URL = "http://itsthisforthat.com/";
    ...
    @GetMapping("/startup")
    public StartUp startup() throws IOException {
        return useStartup();
    }

    protected StartUp useStartup() throws IOException {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(STARTUP_URL)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        ApiInterface apiInterface = retrofit.create(ApiInterface.class);
        Call<StartUp> call = apiInterface.getStartUp();
        Response<StartUp> response = call.execute();
